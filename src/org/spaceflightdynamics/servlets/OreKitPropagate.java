...
//    	out.println(getServletConfig().getInitParameter("param1"));
	...
	protected String usage(HttpServletRequest request) {
		...
		usageText = usageText + "  3) <a href=\"http://localhost:8080/SFDaaS/orekit/propagate?cf=1&t0=2010-05-28T12:00:00.000&tf=2010-05-29T12:00:00.000&r0=[3198022.67,2901879.73,5142928.95]&v0=[-6129.640631,4489.647187,1284.511245]\" target=\"orekit_eg_3\">Propagation with Memcaching using default values (should return 'HTTP Status 500' error because memcaching server and port are undefined)</a>\n";
		usageText = usageText + "  4) <a href=\"http://localhost:8080/SFDaaS/orekit/propagate?cf=1&ca=127.0.0.1:11211&%20127.0.0.1:112112%20192.168.1.101:11211&t0=2010-05-28T12:00:00.000&tf=2010-05-29T12:00:00.000&r0=[3198022.67,2901879.73,5142928.95]&v0=[-6129.640631,4489.647187,1284.511245]\" target=\"orekit_eg_4\">Propagation with Memcaching using default values with 3 memcaching servers defined.</a>\n";
		usageText = usageText + "  5) <a href=\"http://localhost:8080/SFDaaS/orekit/propagate?cf=1&ct=15&ca=127.0.0.1:11211&%20127.0.0.1:112112%20192.168.1.101:11211&t0=2010-05-28T12:00:00.000&tf=2010-05-29T12:00:00.000&r0=[3198022.67,2901879.73,5142928.95]&v0=[-6129.640631,4489.647187,1284.511245]\" target=\"orekit_eg_5\">Propagation with Memcaching using ct=15, i.e. cache for 15 seconds only</a>\n";
